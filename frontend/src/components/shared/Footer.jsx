...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-200 py-5 px-10 text-center sm:text-start">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-2xl font-bold">Job<span className='text-[#5b30a6]'>Hub</span></h2>
